 ...
 ****************************************************************************/
#define NISCOPE_MAJOR_VERSION         18    /* Instrument driver major version */
...
#define NISCOPE_ATTR_GLITCH_CONDITION         IVISCOPE_ATTR_GLITCH_CONDITION         /* ViInt32            */
#define NISCOPE_ATTR_GLITCH_WIDTH             IVISCOPE_ATTR_GLITCH_WIDTH             /* ViReal64,  seconds */
#define NISCOPE_ATTR_GLITCH_POLARITY          IVISCOPE_ATTR_GLITCH_POLARITY          /* ViInt32            */

      /*- IviScopeWidthTrigger Extension -*/
#define NISCOPE_ATTR_WIDTH_CONDITION          IVISCOPE_ATTR_WIDTH_CONDITION          /* ViInt32            */
#define NISCOPE_ATTR_WIDTH_LOW_THRESHOLD      IVISCOPE_ATTR_WIDTH_LOW_THRESHOLD      /* ViReal64,  seconds */
#define NISCOPE_ATTR_WIDTH_HIGH_THRESHOLD     IVISCOPE_ATTR_WIDTH_HIGH_THRESHOLD     /* ViReal64,  seconds */
#define NISCOPE_ATTR_WIDTH_POLARITY           IVISCOPE_ATTR_WIDTH_POLARITY           /* ViInt32            */

      /*- IviScopeRuntTrigger Extension -*/
#define NISCOPE_ATTR_RUNT_LOW_THRESHOLD       IVISCOPE_ATTR_RUNT_LOW_THRESHOLD       /* ViReal64,  volts   */
#define NISCOPE_ATTR_RUNT_HIGH_THRESHOLD      IVISCOPE_ATTR_RUNT_HIGH_THRESHOLD      /* ViReal64,  volts   */
#define NISCOPE_ATTR_RUNT_POLARITY            IVISCOPE_ATTR_RUNT_POLARITY            /* ViInt32            */
...
#define NISCOPE_ATTR_END_OF_RECORD_TO_ADVANCE_TRIGGER_HOLDOFF (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 366L) /* ViReal64 */

   /* New attributes for NI-SCOPE 15.1 */
#define NISCOPE_ATTR_ABSOLUTE_SAMPLE_CLOCK_OFFSET (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 374L) /* ViReal64 */
#define NISCOPE_ATTR_FPGA_BITFILE_PATH            (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 375L) /* ViString */

   /* New attributes for NI-SCOPE 16.1 */
#define NISCOPE_ATTR_INTERLEAVING_OFFSET_CORRECTION_ENABLED (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 376L) /* ViBoolean */
#define NISCOPE_ATTR_HIGH_PASS_FILTER_FREQUENCY             (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 377L) /* ViReal64 */

   /* New attributes for NI-SCOPE 18.6 */
#define NISCOPE_ATTR_RUNT_TIME_CONDITION                    (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 132L) /* ViInt32 */
#define NISCOPE_ATTR_RUNT_TIME_LOW_LIMIT                    (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 133L) /* ViReal64 */
#define NISCOPE_ATTR_RUNT_TIME_HIGH_LIMIT                   (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 134L) /* ViReal64 */

   /* New attributes for NI-SCOPE 18.7 */
#define NISCOPE_ATTR_CABLE_SENSE_VOLTAGE                    (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 137L) /* ViReal64 */
#define NISCOPE_ATTR_CABLE_SENSE_MODE                       (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 138L) /* ViInt32 */
#define NISCOPE_ATTR_CABLE_SENSE_SIGNAL_ENABLE              (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 139L) /* ViBoolean */

   /* New attributes for NI-SCOPE 19.0 */
#define NISCOPE_ATTR_ENABLED_CHANNELS                       (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 140L) /* ViString, read-only */
...
#define NISCOPE_VAL_GLITCH_TRIGGER               IVISCOPE_VAL_GLITCH_TRIGGER
#define NISCOPE_VAL_WIDTH_TRIGGER                IVISCOPE_VAL_WIDTH_TRIGGER
#define NISCOPE_VAL_RUNT_TRIGGER                 IVISCOPE_VAL_RUNT_TRIGGER
...
#define NISCOPE_VAL_SLOPE_EITHER                 3
...
/*- Defined values for NISCOPE_ATTR_GLITCH_CONDITION -*/
#define NISCOPE_VAL_GLITCH_GREATER_THAN          IVISCOPE_VAL_GLITCH_GREATER_THAN
#define NISCOPE_VAL_GLITCH_LESS_THAN             IVISCOPE_VAL_GLITCH_LESS_THAN

/*- Defined values for NISCOPE_ATTR_GLITCH_POLARITY -*/
#define NISCOPE_VAL_GLITCH_POSITIVE              IVISCOPE_VAL_GLITCH_POSITIVE
#define NISCOPE_VAL_GLITCH_NEGATIVE              IVISCOPE_VAL_GLITCH_NEGATIVE
#define NISCOPE_VAL_GLITCH_EITHER                IVISCOPE_VAL_GLITCH_EITHER

/*- Defined values for NISCOPE_ATTR_WIDTH_CONDITION -*/
#define NISCOPE_VAL_WIDTH_WITHIN                 IVISCOPE_VAL_WIDTH_WITHIN
#define NISCOPE_VAL_WIDTH_OUTSIDE                IVISCOPE_VAL_WIDTH_OUTSIDE

/*- Defined values for NISCOPE_ATTR_WIDTH_POLARITY -*/
#define NISCOPE_VAL_WIDTH_POSITIVE               IVISCOPE_VAL_WIDTH_POSITIVE
#define NISCOPE_VAL_WIDTH_NEGATIVE               IVISCOPE_VAL_WIDTH_NEGATIVE
#define NISCOPE_VAL_WIDTH_EITHER                 IVISCOPE_VAL_WIDTH_EITHER

/*- Defined values for NISCOPE_ATTR_RUNT_POLARITY -*/
#define NISCOPE_VAL_RUNT_POSITIVE                IVISCOPE_VAL_RUNT_POSITIVE
#define NISCOPE_VAL_RUNT_NEGATIVE                IVISCOPE_VAL_RUNT_NEGATIVE
#define NISCOPE_VAL_RUNT_EITHER                  IVISCOPE_VAL_RUNT_EITHER

/*- Defined values for NISCOPE_ATTR_RUNT_TIME_CONDITION -*/
#define NISCOPE_VAL_RUNT_TIME_CONDITION_NONE     0
#define NISCOPE_VAL_RUNT_TIME_CONDITION_WITHIN   1
#define NISCOPE_VAL_RUNT_TIME_CONDITION_OUTSIDE  2

/*- Defined values for NISCOPE_ATTR_CABLE_SENSE_MODE -*/
#define NISCOPE_VAL_CABLE_SENSE_MODE_DISABLED    0
#define NISCOPE_VAL_CABLE_SENSE_MODE_ON_DEMAND   1
...
/* #define NISCOPE_VAL_PXIE_DSTAR_A                  DEFINED ABOVE */
/* #define NISCOPE_VAL_AUX_0_CLK_IN                  DEFINED ABOVE */
/* #define NISCOPE_VAL_ONBOARD_CONFIGURABLE_RATE_CLK DEFINED ABOVE */
...
#define NISCOPE_VAL_ENTERING_OR_LEAVING_WINDOW   2
...
#define NISCOPE_VAL_MAX_TIME_INFINITE            (0xFFFFFFFFUL)
#define NISCOPE_VAL_MAX_TIME_IMMEDIATE           (0L)
/*- Keep NISCOPE_VAL_MAX_TIME_NONE for compatibility - use NISCOPE_VAL_MAX_TIME_IMMEDIATE
    for new programs -*/
#define NISCOPE_VAL_MAX_TIME_NONE                (0L)
...
ViStatus _VI_FUNC niScope_ConfigureTriggerGlitch (ViSession vi,
                                                  ViConstString triggerSource,
                                                  ViReal64 level,
...
ViStatus _VI_FUNC niScope_ConfigureTriggerWidth (ViSession vi,
                                                 ViConstString triggerSource,
                                                 ViReal64 level,
...
ViStatus _VI_FUNC niScope_ConfigureTriggerRunt (ViSession vi,
                                                ViConstString triggerSource,
...
ViStatus _VI_FUNC niScope_GetEqualizationFilterCoefficients (ViSession vi,
                                                             ViConstString channel,
                                                             ViInt32 numberOfCoefficients,
                                                             ViReal64* coefficients);
...
/*------ Status -----------------------------------------------------------*/
ViStatus _VI_FUNC niScope_AcquisitionStatus (ViSession vi, ViInt32* acqStatus);
...
ViStatus _VI_FUNC niScope_CalSelfCalibrate (ViSession vi,
...
ViStatus _VI_FUNC niScope_CableSenseSignalStart (ViSession vi);

ViStatus _VI_FUNC niScope_CableSenseSignalStop (ViSession vi);

ViStatus _VI_FUNC niScope_IsDeviceReady  (ViRsrc resourceName,
                                            ViConstString channelList,
                                            ViBoolean* deviceReady);

ViStatus _VI_FUNC niScope_GetChannelName(ViSession vi,
                                         ViInt32 index,
                                         ViInt32 bufferSize,
                                         ViChar name[]);

ViStatus _VI_FUNC niScope_GetChannelNameFromString(ViSession vi,
                                                   ViConstString index,
                                                   ViInt32 bufferSize,
                                                   ViChar name[]);
...
ViStatus _VI_FUNC niScope_ImportAttributeConfigurationBuffer(ViSession vi, ViInt32 sizeInBytes, ViAddr configuration);
ViStatus _VI_FUNC niScope_ExportAttributeConfigurationBuffer(ViSession vi, ViInt32 sizeInBytes, ViAddr configuration);
ViStatus _VI_FUNC niScope_ImportAttributeConfigurationFile(ViSession vi, ViConstString filePath);
ViStatus _VI_FUNC niScope_ExportAttributeConfigurationFile(ViSession vi, ViConstString filePath);
...
#define NISCOPE_ERROR_INVALID_FETCH_POSITION          (IVI_SPECIFIC_ERROR_BASE+0X045L)
#define NISCOPE_ERROR_RIS_MODE_NOT_SUPPORTED_WITH_P2P (IVI_SPECIFIC_ERROR_BASE+0X046L)
