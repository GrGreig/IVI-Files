 ...
 ****************************************************************************/
#define PI40IVRT_MAJOR_VERSION                4     /* Instrument driver major version   */
#define PI40IVRT_MINOR_VERSION                15     /* Instrument driver minor version   */
...
#define PI40IVRT_SUPPORTED_INSTRUMENT_MODELS  "System40,System45,System50"
...
#define PI40IVRT_ATTR_DEFER_THREAD_ERROR        (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 5L)    /* ViInt32 */ //used for deferring of commands - error that may have happened in defer thread
#define PI40IVRT_ATTR_SERIAL_NUMBER             (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 6L)    /* ViString (Read Only) */
...
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_GetPrecResistorInfo(ViSession vi, ViUInt32 SubUnit, 
...
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattSetVoltage(ViSession vi, ViUInt32 SubNum, double Voltage);
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattGetVoltage(ViSession vi, ViUInt32 SubNum, double* Voltage);
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattSetCurrent(ViSession vi, ViUInt32 SubNum, double Current);
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattGetCurrent(ViSession vi, ViUInt32 SubNum, double* Current);
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattSetEnable(ViSession vi, ViUInt32 SubNum, ViUInt32 Pattern);
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattGetEnable(ViSession vi, ViUInt32 SubNum, ViUInt32* Pattern);
ViStatus _PI40IVRT_API _VI_FUNC   pi40ivrt_BattReadInterlockState(ViSession vi, ViUInt32 SubNum, ViBoolean* Interlock);
...
#define PI40IVRT_ERROR_130_ERRORS					(PI40IVRT_ERROR_PIPLX_MARK + 7)	//base + 112 new errors in CB 1.3
#define PI40IVRT_ERROR_PICMLX_CLI_BEGINTRANS		(PI40IVRT_ERROR_130_ERRORS)
#define PI40IVRT_ERROR_PICMLX_CLI_ENDTRANS			(PI40IVRT_ERROR_130_ERRORS + 1)
#define PI40IVRT_ERROR_PICMLX_CLI_INVALID_INDEX		(PI40IVRT_ERROR_130_ERRORS + 2)
#define PI40IVRT_ERROR_PICMLX_CLI_DIRECTECHO_FAILED (PI40IVRT_ERROR_130_ERRORS + 3)
#define PI40IVRT_ERROR_PICMLX_CLI_BROADCASTECHO_FAILED (PI40IVRT_ERROR_130_ERRORS + 4)

#define PI40IVRT_ERROR_132_ERRORS					(PI40IVRT_ERROR_130_ERRORS + 5)	//base + 117 new errors in CB 1.3.2
#define PI40IVRT_ERROR_CARD_TYPE					(PI40IVRT_ERROR_132_ERRORS)
#define PI40IVRT_ERROR_BAD_POLE						(PI40IVRT_ERROR_132_ERRORS + 1)
#define PI40IVRT_ERROR_MISSING_CAPABILITY			(PI40IVRT_ERROR_132_ERRORS + 2)
#define PI40IVRT_ERROR_MISSING_HARDWARE				(PI40IVRT_ERROR_132_ERRORS + 3)
#define PI40IVRT_ERROR_HARDWARE_FAULT				(PI40IVRT_ERROR_132_ERRORS + 4)
#define PI40IVRT_ERROR_EXECUTION_FAIL				(PI40IVRT_ERROR_132_ERRORS + 5)
#define PI40IVRT_ERROR_BAD_CURRENT					(PI40IVRT_ERROR_132_ERRORS + 6)

#define PI40IVRT_ERROR_BAD_RANGE					(PI40IVRT_ERROR_132_ERRORS + 7) //new pilpxi errors
#define PI40IVRT_ERROR_ATTR_UNSUPPORTED				(PI40IVRT_ERROR_132_ERRORS + 8)
#define PI40IVRT_ERROR_BAD_REGISTER					(PI40IVRT_ERROR_132_ERRORS + 9)

#define PI40IVRT_ERROR_EXT_DLL_FAIL					(PI40IVRT_ERROR_132_ERRORS + 10)

#define PI40IVRT_ERROR_XML_MODULE_NOT_FOUND			(PI40IVRT_ERROR_132_ERRORS + 11)
#define PI40IVRT_ERROR_XML_FILE_NOT_FOUND			(PI40IVRT_ERROR_132_ERRORS + 12)

#define PI40IVRT_ERROR_SIM_SPECIFIC					(PI40IVRT_ERROR_132_ERRORS + 13)

#define PI40IVRT_ERROR_MATRIXP_ILLEGAL				(PI40IVRT_ERROR_132_ERRORS + 14) // new pilpxi error
...
#define	PI40IVRT_TYPE_BATT		10	// Battery simulator
#define	PI40IVRT_TYPE_VSOURCE	11	// Programmable voltage source 
#define	PI40IVRT_TYPE_MATP		12	// Matrix with restricted operating modes
#define	PI40IVRT_TYPE_MUXMS 	13	// MUXM and MUX
#define	PI40IVRT_TYPE_FI		14	// Fault Insertion sub

//Battery simulator all subunit definition
#define PI40IVrt_BATT_ALL_BATT_SUB_UNITS	0    ///< All sub-units
...
#define PI40IVRT_CFG_CARD_RFMATR726			3		//automated 726 RF matrix card
#define PI40IVRT_CFG_CARD_RFMATR726LT		4		//automated 726 RF matrix card with loopthru
#define PI40IVRT_CFG_CARD_RFMATR726TST		5		//automated 726 RF with loophtru allowing more connections on row
#define PI40IVRT_CFG_CARD_BRIC560DUALBUS	6		//automated BRIC matrix with dual bus (e.g. x1-x10, yA1-yA5, yB1-yB5)
													//type 40-560-....-M and 60-550 etc.
#define PI40IVRT_CFG_CARD_BRIC566AUTOISOL	7		//BRIC card with manual isolators on daughter cards
#define PI40IVRT_CFG_CARD_MATR60760			8		//automated 60-670 matrix card
#define PI40IVRT_CFG_CARD_MATR60390			9		//automated 60-390 matrix card
#define PI40IVRT_CFG_CARD_MATRLT			10		//Loopthru on both matr axis
#define PI40IVRT_CFG_CARD_MATR727			11		//Isolation relays on Y axis
#define PI40IVRT_CFG_CARD_MATR727LT			12		//Isolation relays on Y axis and loopthru on Y axis
